...
def display_average_popularity_by_genre(df: pd.DataFrame, chart_color: str = "#4D7298"):
    ...
    ax.bar(avg_popularity.index, avg_popularity.values, color = chart_color)
...
def display_selected_averages(df: pd.DataFrame, chosen_genre: str, vars_list: list, chosen_subgenre: str = "No Preferred Subgenre", selected_color: str = "#174CDD"):
    """
    ...
    for var in numeric_vars:
        ...
        generate_visuals_streamlit(chosen_genre, var, var_values, selected_color, cols[curr_col_num])
        curr_col_num += 1
    ...
    if chosen_subgenre != "No Preferred Subgenre":
        ...
        for var in numeric_vars:
            ...
            generate_visuals_streamlit(chosen_subgenre, var, var_values, selected_color, cols[curr_col_num], subgenre=True)
            curr_col_num += 1
            
    st.markdown("-----")

#this function then generates the bar chart 
def generate_visuals_streamlit(genre: str, var: str, values, selected_color: str, col, subgenre: bool = False):
    """
